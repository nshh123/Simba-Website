  ...
  return (
    <>
      <button
        ...
        className={`fixed bottom-6 right-6 z-[100] h-14 w-14 rounded-full shadow-2xl flex items-center justify-center transition-all hover:scale-110 active:scale-95 ${
          isOpen 
      ...
      {isOpen && (
        <div className="fixed bottom-24 right-6 z-[100] w-[calc(100vw-3rem)] max-w-[450px] h-[70vh] max-h-[650px] shadow-2xl flex flex-col overflow-hidden animate-in fade-in slide-in-from-bottom-5 duration-300 rounded-3xl border border-white/20 dark:border-gray-800 bg-white/90 dark:bg-gray-950/90 backdrop-blur-xl">
